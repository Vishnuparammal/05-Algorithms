// Video Link 1: https://www.youtube.com/watch?v=Bp7fGofslng
// Video Link 2: https://www.youtube.com/watch?v=ATK74YSzwxg

/*
	When run on a local machine, it produces sample input file 
	“input.txt” with 10000 random numbers. It sorts the numbers 
	and puts the sorted numbers in a file “output.txt”. 
	
	It also generates files with names 1, 2, .. to store sorted runs.
*/
...
public: 
	...
	// to get the minimum element i.e. root
